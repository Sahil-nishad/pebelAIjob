...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "interview coach free", "behavioral interview practice", "technical interview prep",
    "fresher job search india", "campus placement preparation",
  ],
  ...
  verification: {
    google: ["76627f6cd45198c1", "1D84yWi_AUOxo_eC4xtrJ8EspZqMW9Pp1fHJr4StkKg"],
  },
